...
| `host-tools/rc2-sd-bridge/` | Finite diagnostic-session host client and exact-path MTP transport | Source and host fixtures; operator-started PING/F4/PING round trip observed, no aircraft or attach operation |
