...
| `host-tools/rc2-sd-bridge/` | Finite diagnostic-session host client and exact-path MTP transport | Source and host fixtures; B1 diagnostics and B2 fixed canary load/cleanup observed; no aircraft protocol operation |
