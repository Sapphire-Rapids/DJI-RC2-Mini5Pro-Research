#!/usr/bin/env python3
"""Single-target DJI Assistant downloader for rc331 10.00.0700/0200.

The only compiled target is the official RC 2 DJI Fly/application-image candidate
``rc331/10.00.0700/0200``. No product, version, module, URL, filename, output
...
LOCKED_TARGET = LockedTarget(
    ...
    module_id="0200",
    module_version="12.14.13.85",
    filename="rc331_0200_v12.14.13.85_20260610.pro.fw.sig",
    size=454_223_680,
    md5="cc219b04c4fcf34d8b14569a7e55eae1",
)
...
def _request_redirect(
    ...
    headers = {
        ...
        "Connection": "close",
        "User-Agent": "DJI-Assistant-rc331-0200-locked-audit/1.0",
    }
...
def _stream_cdn(
    ...
    temporary_name = f".rc331-0200-locked-{secrets.token_hex(16)}.part"
    descriptor = os.open(
        temporary_name,
