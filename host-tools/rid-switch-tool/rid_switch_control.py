...
never sends a write unless a same-session F7/F8 baseline exists, and it attempts to
restore that baseline immediately after any possible forward write. It has no generic
