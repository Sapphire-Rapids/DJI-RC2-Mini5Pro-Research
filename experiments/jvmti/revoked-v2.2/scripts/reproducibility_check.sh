...
artifact=$project_dir/dist/FindUAS-JVMTI-EID-Route-Resolver-V2.2-0.1.0-offline-unadmitted-arm64-v8a.apk
temporary_dir=$(mktemp -d "${TMPDIR:-/tmp}/finduas-route-v22-repro.XXXXXX")
