...
| C-149 | `STATIC` | Current native FlySafe maps inventory/set-enable to `0x11/0x11` and `0x11/0x12`, with product-139 receiver `0x92` and exact V2/V3/V4 schemas | Live Binder acceptance, support/version, genuine type-6 inventory, mutation, restore, and RF remain open; license material is excluded |
