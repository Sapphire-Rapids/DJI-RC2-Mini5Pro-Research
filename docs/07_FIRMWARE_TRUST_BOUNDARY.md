...
`OBSERVED`：2026-08-30 操作者确认本机 Mini 5 Pro 飞机固件为 `01.00.0600`（C-220）。该版本
落在 CVE-2026-78306 与 CVE-2026-77812 声明的受影响窗口（`<=01.00.0600`）内，因此本机仍待
固件升级修复这两条 BLE/DUML 网络面；此事实不改变任何 Remote ID 开关结论。
