 ...
 * {@code rid_ctrl_enable_0} ({@code 0x3CBD864F}).
 *
 * <p>This class does not perform I/O. It deliberately has no API for selecting
 * another parameter name or hash.</p>
 */
public final class RidControlParameter {
    public static final String NAME = "rid_ctrl_enable_0";
    public static final int HASH = 0x3CBD864F;
    ...
    private static boolean decodeBoolean(byte[] raw, Metadata metadata) {
        ...
        throw new ProtocolException("RID control value is not exactly Boolean 0 or 1");
    }
    ...
    private static void requireWritableBooleanMetadata(Metadata metadata) {
        ...
        // F7 carries only four bytes for min/max/default. Reject wider types rather than
        // guessing how a truncated range should be interpreted.
